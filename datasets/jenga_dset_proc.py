...
class LazyVideo:
    ...
    def __getitem__(self, item):
        ...
        # If single index was requested, remove the time dimension
...
class JengaDataset(TrajDataset):
    def __init__(
        ...
        # Track targets and actuals separately for normalization
        all_actions = []
        all_proprios = []
        ...
        for ep_dir in self.episode_dirs:
            ...
            # 4. Load Vectors (SEPARATING COMMANDS VS ACTUALS)
        ...
        # 5. Independent Normalization Stats
